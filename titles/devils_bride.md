...
![Movie Cover](../utils/covers/devils_bride.jpg)
...
| Status             | Watched                     |
| Watch Start Date   | 24th March 2026             |
| Watch End Date     | 25th March 2026             |
| Runtime            | 1h 30m                      |
| Rating             | ★★☆☆☆ (4.5/10)              |
| Platform           | Home                        |
| Language           | Indonesian                  |
...
The direction by Fajar Aditya is serviceable but ultimately uninspired. While there are a few visually striking sequences representing Echa's nightmares, the overall execution feels flat and lacks the dread required to make the horror land. The performances are a mixed bag; the actors do their best with the material they're given, but the script relies heavily on predictable dialogue and exaggerated reactions, preventing any meaningful emotional investment in the characters' plight.
...
|---|---|---|
| **Cinematography** | **5.5/10** | Some effective nightmare imagery, but mostly standard. |
| **Plot** | **4.5/10** | Interesting premise weighed down by clichés. |
| **Story** | **4.0/10** | Drags significantly; lacks tension. |
| **Character Development** | **4.0/10** | Hard to connect with anyone on screen. |
| **Enjoyment** | **4.0/10** | A chore to get through at times. |
| **Scares/Horror** | **4.5/10** | Relies too much on loud noises rather than dread. |
| **Overall** | **4.5/10** | **Below Average** |
| **Pace** | **Sluggish** | Feels longer than its 90-minute runtime. |
...
- The initial nightmare sequence had some atmospheric promise before it devolved into routine jump scares.

---

## Rewatch Value

**Would I watch again?** No. Once was enough.

**Best watched:** If you've run out of other Indonesian horror films to watch.
...
Also known by its original title "Pengantin Setan".
