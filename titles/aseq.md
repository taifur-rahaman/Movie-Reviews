...
| Status             | Watched                     |
| Watch Date         | 3rd-4th February 2026       |
| Runtime            | 1h 47m                      |
| Rating             | ★★☆☆☆ (3.5/10)             |
| Platform           | Home                        |
| Language           | Hindi                       |
...
The film attempts to build its horror around the mythology of Jinn—supernatural entities from Islamic mythology. On paper, this is a fascinating and underutilized concept for horror. In execution? Absolutely boring as hell.

The movie's fatal flaw is its need to explain EVERYTHING. Instead of letting the atmosphere and story do the heavy lifting, we get full-on lectures about what a Jinn is, complete with animal examples and detailed exposition. Dude, I came here to watch a horror movie, not attend a mythology class. Show, don't tell! The constant over-explanation kills any tension that might be building.

The pacing is painfully slow. Story progression feels like watching paint dry. Things that could be established in a few tense scenes are dragged out endlessly. The film doesn't trust its audience to pick up on context clues or understand the mythology through the actual horror—it has to spoon-feed everything.

Worst of all? **No scary moments.** Zero. Zilch. For a horror movie, that's an unforgivable sin. The story itself is interesting, but the execution is horrible. It's like having all the right ingredients for a great meal and somehow still burning it.

## Performances & Direction

Sarim Momin's direction leans heavily on exposition rather than atmosphere. The choice to over-explain the Jinn mythology instead of weaving it naturally into the narrative is a major misstep. Horror works best when there's mystery and the unknown—when you explain every detail, you remove the fear.

The cast includes Vardhan Puri, Sonnalli Seygall, and Siddhanth Kapoor. Performances are serviceable, but it's hard to shine when the script keeps interrupting any potential tension with exposition dumps. The actors do what they can with the material, but no amount of good acting can save a horror film with zero scares.
...
**Skip this one.** If you're interested in Jinn mythology, read a book. If you want horror, watch literally anything else.
...
|---|---|---|
| **Cinematography** | **5.5** | Decent production values, nothing special. |
| **Plot** | **6.0** | Interesting Jinn mythology concept. |
| **Story** | **3.0** | Horrible execution ruins the interesting premise. |
| **Character Development** | **4.0** | Serviceable but nothing memorable. |
| **Scares/Horror** | **0.5** | Zero scary moments. Unforgivable for a horror film. |
| **Enjoyment** | **2.0** | Boring as hell. Glacial pacing throughout. |
| **Overall** | **3.5** | **Below Average** (wasted potential) |
| **Pace** | **Glacial** | Painfully slow with excessive exposition |
...
### Completed - 4th February 2026

**Final Thoughts:**

Finished it. Wish I hadn't.

**Major Issues:**

- **Pacing is glacial** - Story moves at a snail's pace. Nothing happens with any urgency.
- **Zero scares** - Not a single scary moment in the entire film. For a horror movie, this is unforgivable.
- **Over-explanation kills tension** - The film literally stops to explain what a Jinn is, with examples of animals and detailed mythology breakdowns. WTF man... am I watching a horror movie or a lecture?
- **Show, don't tell** - Basic filmmaking rule being violated constantly. Instead of letting us experience the horror, they're explaining it to death.
- **Horrible execution** - Interesting story completely wasted by terrible direction and pacing.

**What Could Have Worked:**

- Jinn mythology is genuinely interesting and underutilized in horror
- There was potential for atmospheric dread if they'd just let it breathe
- The concept itself is solid—execution is the problem

**Watching Experience:**

- Platform: Home
- Watch period: 3rd-4th February 2026
- Final mood: Bored and disappointed
- Time wasted: 1h 47m I'll never get back

---

## Rewatch Value

**Would I watch again?** ❌ Absolutely not. Once was more than enough.

**Best watched:** Not at all. Save yourself the time.
